...
public class InMemoryCurrencyConverter implements CurrencyConverter {
    ...
    public static void main(String[] args) {
        ...
        double v = inMemoryCurrencyConverter.conversationTable[2][0];
        System.out.println(v);
        double rubToUsd = inMemoryCurrencyConverter.convert(Currency.RUB, 1000, Currency.USD);
        System.out.println(rubToUsd);
    }
}